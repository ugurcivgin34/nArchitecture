...
namespace Application.Features.Models.Queries.GetListModel
{
    public class GetListModelQuery : IRequest<ModelListModel>
    {
        ...
        public class GetListModelQueryHandler : IRequestHandler<GetListModelQuery, ModelListModel>
        {
            ...
            {
                                 //car models
                IPaginate<Model> models = await _modelRepository.GetListAsync(include: //Birden fazla join işlemi gerekirse .Include diyerek devam edebiliriz.
                               ...
                               //dataModel
                ModelListModel mappedMdels = _mapper.Map<ModelListModel>(models);
                return mappedMdels;
            }
        }
    }
