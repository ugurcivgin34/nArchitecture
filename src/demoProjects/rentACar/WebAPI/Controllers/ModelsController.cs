...
namespace WebAPI.Controllers
{
    ...
    public class ModelsController : BaseController
    {
        ...
        public async Task<IActionResult> GetListByDynamic([FromQuery] PageRequest pageRequest,[FromBody] Dynamic dynamic)//Dyamic i bir json objesi olarak istediğimiz için post olarak yazdık
        {
